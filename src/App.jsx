...
function App() {
  ...
  return (
    <div className='w-full h-screen duration-200' style={{ backgroundColor:color }} >
      ...
      {/* <div className='flex p-1  bg-red-100 gap-3 mx-auto text-center text-white shadow-lg'>
      <button className='bg-red-500 w-12 p-3 ml-10 rounded-full  shadow-xs'>Red</button>
      <button className='bg-red-500 px-3 ml-10 rounded-full  shadow-xs'>Red</button>
    </div>
   */}
